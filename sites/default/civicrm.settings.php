...
if (!defined('CIVICRM_UF_DSN') && CIVICRM_UF !== 'UnitTests') {
  define( 'CIVICRM_UF_DSN'           , 'mysql://drupaluser:Sp2527@localhost/drupal?new_link=true');
}
...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests' && isset($GLOBALS['_CV']['TEST_DB_DSN'])) {
    ...
    define('CIVICRM_DSN', 'mysql://civicrm_user:8M4j36@127.0.0.1/civicrm?new_link=true');
  }
}
...
$civicrm_root = '/var/www/civicrm.neosbybold.com//sites/all/modules/civicrm';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', '/var/www/civicrm.neosbybold.com/sites/default/files/civicrm/templates_c');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', 'c371154c6f3bdb7dadd80e7ebd7fb307');
}
...
// define( 'CIVICRM_MAIL_LOG', '/var/www/civicrm.neosbybold.com/sites/default/files/civicrm/templates_c/mail.log');
// }
